...
const saveSettings = async (req, res) => {
    try {
        const { siteTitle, seoDescription, footerText, siteLogoUrl, faviconUrl, facebookLink, facebookText, instagramLink, instagramText, telegramLink, telegramText, youtubeLink, youtubeText, whatsappLink, whatsappText, skypeLink, skypeText, helpLink, helpText, twitterLink, twitterText, maintenanceMode, // boolean
        popupText, // string
