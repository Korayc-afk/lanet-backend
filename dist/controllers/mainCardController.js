...
exports.deleteMainCard = exports.updateMainCard = exports.createMainCard = exports.getMainCards = void 0;
const prisma_1 = __importDefault(require("../lib/prisma"));
// GET - Kartları listele
const getMainCards = async (req, res) => {
    try {
        const cards = await prisma_1.default.mainCard.findMany({
            orderBy: { order: "asc" },
        });
...
exports.getMainCards = getMainCards;
// POST - Yeni kart oluştur
const createMainCard = async (req, res) => {
    try {
        ...
        const newCard = await prisma_1.default.mainCard.create({
            data: {
                href,
...
exports.createMainCard = createMainCard;
// PUT - Kart güncelle
const updateMainCard = async (req, res) => {
    ...
    try {
        ...
        const logo = files?.["logoFile"]?.[0];
        const { href, badgeText, order, isActive } = req.body;
        const existingCard = await prisma_1.default.mainCard.findUnique({ where: { id } });
        if (!existingCard)
        ...
        const updatedCard = await prisma_1.default.mainCard.update({
            where: { id },
            data: {
                href,
                badgeText,
...
exports.updateMainCard = updateMainCard;
// DELETE - Kart sil
const deleteMainCard = async (req, res) => {
    const id = Number(req.params.id);
    try {
        const card = await prisma_1.default.mainCard.findUnique({ where: { id } });
        if (!card)
            return res.status(404).json({ success: false, message: "Kart bulunamadı." });
        ...
        await prisma_1.default.mainCard.delete({ where: { id } });
...
exports.deleteMainCard = deleteMainCard;
